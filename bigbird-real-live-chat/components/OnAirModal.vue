      ...
      <div class="modal-wrapper">
        <div class="modal-container clearfix">
                ...
                <ul class="sub-nav-wrap">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span class="admin-chat-notice">999</span>
                    </a>
                  </li>
                  <li>
                    <a
          ...
          <section class="side-content-wrap">
            ...
            <!-- 시청자 목록 -->
            <viewer-list v-show="showView('viewer-list')" />

            <!-- 시청자 목록 -->
            <viewer-management v-show="showView('viewer-management')" />

            <!-- 금지어 설정 -->
            <set-prohibited-words v-show="showView('set-prohibited-words')" />
          </section>
          <!-- 실시간 방송화면 -->
          <section class="live-view-wrap">
            <div class="live-view">
              ...
              <div class="live-info-box">
                ...
                <p>
                  <span class="line995">시청자 198명</span>
                  <!-- <span class="line995">채팅 참여 100명</span> -->
                  <span>방송시간 2020.08.17 - 16:00~16:30</span>
                </p>
              </div>
              <div class="live-streaming-box">방송화면</div>
            </div>
          </section>
          <!-- 실시간 채팅 -->
            ...
            <div class="real-chat">
              ...
              <div class="real-chat-box">
                <ul class="chat-list">
                  <li>
                    <ul>
                      <li class="user-name">홍길동(con01)</li>
                      <li class="user-chat">
